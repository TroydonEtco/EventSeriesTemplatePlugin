                ...
                if (context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity)
                {
                    ...
                    else
                    {
                        ...
                        if (evtSeries.PrimarySeriesTemplate != null)
                        {
                            ...
                            if (string.IsNullOrEmpty(evtSeries.EventSeriesTemplate.Description) || evtSeries.EventSeriesTemplate.CourseType == null || evtSeries.EventSeriesTemplate.RecurrenceType != null)
                            {
